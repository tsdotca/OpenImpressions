...
int main(int argc, char **argv) {
  ...
  window = SDL_CreateWindow(kScreenWindowTitle, SDL_WINDOWPOS_UNDEFINED,
  ...
  const auto screen_fill_colour =
      SDL_MapRGB(screenSurface->format, 0x69, 0xFF, 0x69);
  SDL_FillRect(screenSurface, nullptr, screen_fill_colour);
